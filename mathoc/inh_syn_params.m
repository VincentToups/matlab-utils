function params = inh_syn_params(varargin)
% PARAMS = INH_SYN_PARAMS( ) returns parameters for inhibitory synapses
...
if ~exist('list_or_name')
  list_or_name = {'basilar1ref' 'basilar2ref' 'basilar3ref' 'somaref'};
end
